...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        btnNovelApp = findViewById(R.id.btn_novel_app);
        btnNovelApp.setOnClickListener(onClickListener);
    ...
    private final UserStatusCallback userStatusCallback = new UserStatusCallback() {
        ...
        public void onBlink(long l, boolean b, boolean b1, boolean b2, float v) {
            long timestamp = l;
            boolean isBlinkLeft = b;
            boolean isBlinkRight = b1;
            boolean isBlink = b2;
...
//        }
    ...
    private void showNovelApp() {
        Intent intent = new Intent(getApplicationContext(), NovelMainActivity.class);
        startActivity(intent);
    }
}
